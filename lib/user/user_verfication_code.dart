...
String ?room;
String ?userid;
verifcation({required this.problem_catagory,this.problem_title,this.problme_priority,this.campus,this.building,this.room,this.userid});
  @override
...
class verficationsate extends State<verifcation>
{
  ...
  user_reqsuet()
  {
    ...
    services.userrequet(widget.problem_catagory.toString(),widget.problem_title.toString(),widget.problme_priority.toString(),widget.campus.toString(),
       widget.building.toString(),widget.room.toString(),code.toString(),widget.userid.toString()).then((employees) {
      setState(() {
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: FlatButton(
                            child: Text("DON",style: TextStyle(color: Colors.blue),),
                            onPressed:()
                            {
